...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <link href="web3/css/style.css" rel="stylesheet" />
<link href="web3/css/jqvmap.css" rel="stylesheet" />
<script src="web3/js/Chart1.js"></script>
<script src="web3/js/jquery.min.js"></script>
<script src="web3/js/jquery.vmap.js"></script>
<script src="web3/js/jquery.vmap.sampledata.js"></script>
<script src="web3/js/jquery.vmap.world.js"></script>
...
<div class="list_of_members">
    ...
    <div class="orders">
        ...
        <div>
            <h3><asp:Label ID="Label3" runat="server" Text="45"></asp:Label></h3>
...
<div class="total-world">
    ...
    <div class="site-report">
        ...
        <p>Cv Sistemi projemizin admin paneli kısmındasınız...</p>
    </div>
    <div class="clearfix"></div>
</div>
