...
<html lang="zxx">
<head>
    <title>Tunç Çindaş Cv Web</title>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/resim.jpeg" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Tunç ÇİNDAŞ</a></h1>
            <p class="top_hdp mt-2">Coumputer Programmer</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
    ...
    <div class="main">
        ...
        <section class="slide-wrapper" id="about">
            ...
            <div class="row news-grids-left mt-5">
                <div class="col-lg-5 news_top">
                    <img src="web/images/indir (1).png" alt="news image" class="img-fluid">
                </div>
                <div class="col-lg-5 news_top">
                    <img src="web/images/yazilim_48720.png" alt="news image" class="img-fluid">
                </div>
            </div>
        </section>
        <!-- //about -->
        ...
        <div class="news" id="news">
            ...
            <div class="row news-grids-left mt-5">
                <div class="col-lg-5 news_top">
                    <img src="web/images/indir.png" alt="news image" class="img-fluid">
                </div>
                <div class="col-lg-7 news_top1">

                    <p class="mt-3">Artvin Şavşat Adliyesi Bölüm sonu tamamlama Stajı.</p>
                </div>
            </div>
        </div>
        <!-- //news -->
        ...
        <section class="wedo" id="contact">
            ...
            <div class="cpy-right text-center">
                ...
                <p>
                    <a href="https://www.linkedin.com/in/tun%C3%A7-%C3%A7inda%C5%9F-a1b919254/">Linkedin  ---- </a>
