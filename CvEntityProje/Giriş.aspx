<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giriş.aspx.cs" Inherits="CvEntityProje.Giriş" %>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<asp:TextBox ID="TextBox1" runat="server" class="input100" placeholder="Kullanıcı Adınız..."></asp:TextBox>
